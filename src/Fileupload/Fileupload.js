...
class Fileupload extends Component{
  ...
  onFormSubmit(e){
    ...
    if (!this.state.file){
      ...
      this.fileUpload(this.state.file, this.state.selectValue).then((response)=>{
  ...
  render() {
    return (
      <form onSubmit={this.onFormSubmit}>
        ...
        <select id="lang" onChange={this.onSelectChange} value={this.state.selectValue} >
          <option disabled value="DEFAULT"> -- select an album -- </option>
